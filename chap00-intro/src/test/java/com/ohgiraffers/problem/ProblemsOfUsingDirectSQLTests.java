...
public class ProblemsOfUsingDirectSQLTests {
    ...
    * */
    ...
    // 그래서 번거롭다. Mybatis를 사용해서 개선할 수도 있음(설정값 전달을 통해 자동으로 mapping)
    @Test
    ...
    /* 2. SQL 의존적인 개발 */
    // 기능에 따라 select 할 컬럼의 항목이 달라질 수 있음.
    // sql 구문을 고쳐야 하고, 값을 꺼내오는 부분도 고쳐야 함. 즉 sql에 의존적.
    // JPA를 사용하여 SQL에 대한 의존성을 없앤다. 즉 SQL에 따라 자바 코드를 바꾸는 것을 막는다.
